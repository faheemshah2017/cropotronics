var DatatablesDataSourceAjaxServer = function () {
	...
	var initTable1 = function () {
		...
		table.DataTable({
			...
			serverSide: true,
			ajax: {
				"url": "/power_management/get_datatables_list",
				"type": "POST"
			},
			columns: [
...
function edit_data(row_id) {
	...
	$.ajax({
		url: "/power_management/details/" + row_id,
		cache: false,
		processData: false,
		contentType: 'application/json',
		type: 'GET',
