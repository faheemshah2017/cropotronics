var DatatablesDataSourceAjaxServer = function () {
	...
	var initTable1 = function () {
		...
		table.DataTable({
			...
			serverSide: true,
			ajax: {
				"url": "/farm_maker/get_datatables_list",
				"type": "POST"
			},
			columns: [
				{ name: 'Name', title: 'Name', data: 'title', className: 'dt-body-left' },
				{ name: 'Design', title: 'Design', defaultContent: '', className: 'dt-body-left' },
			...
			columnDefs: [
				{
					...
					render: function (data, type, full, meta) {
						return `
						<form action='farm_maker/edit/`+full._id+`'>
							<button type="submit" class="m-portlet__nav-link btn m-btn m-btn--hover-brand m-btn--icon m-btn--icon-only m-btn--pill edit_flight" id="edit_data">
