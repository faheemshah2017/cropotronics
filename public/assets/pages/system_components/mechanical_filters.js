var DatatablesDataSourceAjaxServer = function () {
	...
	var initTable1 = function () {
		...
		table.DataTable({
			...
			serverSide: true,
			ajax: {
				"url": "/system_components/mechanical_filters/get_datatables_list",
				"type": "POST"
			},
			columns: [
				{ name: 'Name', title: 'Name', data: 'name', className: 'dt-body-left' },
				{ name: 'Depth', title: 'Depth', data: 'depth', className: 'dt-body-left' },
				{ name: 'Width', title: 'Width', data: 'width', className: 'dt-body-left' },
				{ name: 'Length', title: 'Length', data: 'length', className: 'dt-body-left' },
...
function edit_data(row_id) {
	...
	$.ajax({
		url: "/system_components/mechanical_filters/details/" + row_id,
		cache: false,
		processData: false,
		contentType: 'application/json',
		type: 'GET',
...
function edit_submit() {
	...
	$.ajax({
		url: "/system_components/mechanical_filters/update",
		data: JSON.stringify(values),
		cache: false,
		processData: false,
		contentType: 'application/json',
...
function delete_data(row_id) {
	...
	swal({
		...
		if (ev.value) {
			$.ajax({
				url: "/system_components/mechanical_filters/delete",
